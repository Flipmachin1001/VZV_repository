...
INT0:		.ivec    _INT0_Isr				; External User Interrupt #0 				//1

INT1:		.ivec    _INT1_Isr				; External User Interrupt #1

TINT0:		.ivec    _TIMER_isr				; Timer #0 / Software Interrupt #4			//2

PROG0:		.ivec    dummy_isr				; Programmable 0 Interrupt

UART:		.ivec    _TXRX_isr				; IIS #1 Receive Interrupt UART interrupt	//3

PROG1:		.ivec    dummy_isr				; Programmable 1 Interrupt

DMA:		.ivec    _DMA_Isr               ; DMA Interrupt								//4
...
SARADC:		.ivec    _SAR_Isr 				; SAR ADC Interrupt							//5
...
RTC:		.ivec    _RTC_Isr				; RTC interrupt								//6
