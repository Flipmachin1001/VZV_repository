 ...
 *  ADC Module                                                              *
 * ------------------------------------------------------------------------ */
#define SAR_CTRL           *(volatile ioport Uint16*)(0x7012)
#define SAR_DATA           *(volatile ioport Uint16*)(0x7014)
#define SAR_CLKCTRL        *(volatile ioport Uint16*)(0x7016)
#define SAR_PINCTRL        *(volatile ioport Uint16*)(0x7018)
#define SAR_GPOCTRL        *(volatile ioport Uint16*)(0x701A)
